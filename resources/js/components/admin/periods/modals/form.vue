            ...
            <div class="modal-content">
                ...
                <form @submit.prevent="saveData">
                    <div class="modal-body">
                        <div class="mb-5">
                            <label>Nombre</label>
                            <input type="text" v-model="form.name" class="form-control bg-transparent" placeholder="Ingresar el nombre del periodo">
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        saveData() {
            ...
            //     let _this            = this;
            //     if(this.mode == 'edit'){
            //         response_request = axios.put(`/periodos/${this.form.id}`,this.form);
            //     } else {
            //         response_request = axios.post('/periodos',this.form);
            //     }
            //     if(response_request) {
